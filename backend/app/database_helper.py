...
def seed_database():
    ...
    burgare = create_category(**{'name': 'Burgare', 'position': 1, 'company': test_company})
    indisk = create_category(**{'name': 'Indiskt', 'position': 1, 'company': test_company_2})
    dryck = create_category(**{'name': 'Dryck', 'position': 2, 'company': test_company})
    extra = create_category(**{'name': 'Extra', 'position': 2, 'company': test_company_3})
    product1 = create_product(**{'name': 'Hamburgare', 'price': 10.99, 'company': test_company, 'position': 1, 'category': burgare})
    product2 = create_product(**{'name': 'Sallad', 'price': 8.49, 'company': test_company, 'position': 2, 'category': burgare})
    product3 = create_product(**{'name': 'Falafel', 'price': 5.49, 'company': test_company, 'position': 3, 'category': burgare})
    product4 = create_product(**{'name': 'Vatten', 'price': 2, 'company': test_company, 'position': 1, 'category': dryck})
    product5 = create_product(**{'name': 'Cola', 'price': 2.5, 'company': test_company, 'position': 2, 'category': dryck})
