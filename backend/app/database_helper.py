...
def seed_database():
    ...
    product1 = create_product(**{'name': 'Hamburgare', 'price': 0.30, 'company': mastega_company, 'category': 'Mat'})
    product2 = create_product(**{'name': 'Sallad', 'price': 0.25, 'company': mastega_company, 'category': 'Mat'})
    product3 = create_product(**{'name': 'Falafel', 'price': 0.25, 'company': mastega_company, 'category': 'Mat'})
    product4 = create_product(**{'name': 'Vatten', 'price': 0.10, 'company': mastega_company, 'category': 'Dricka'})
    product5 = create_product(**{'name': 'Cola', 'price': 0.20, 'company': mastega_company, 'category': 'Dricka'})
