...
import { signInUser, startNewRegistration } from '../redux/actions'
          ...
          <TouchableWithoutFeedback style={styles.container} onPress={Keyboard.dismiss}>
            <View style={styles.container}>
              ...
              <View style={styles.infoContainer}>
                ...
                <Text onPress={() => {this.props.startNewRegistration(), this.props.navigation.navigate('Register')}} style={styles.signUpText}>Sign Up</Text>
              </View>
            </View>
...
const mapDispatchToProps = dispatch => ({
  ...
  startNewRegistration: () => dispatch(startNewRegistration())
})
